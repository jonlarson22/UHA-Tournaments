...
function generateMatchCardHTML(match, divIdx, rIdx, mIdx, bracketType = 'winners') {
    ...
    if (isViewingArchive) {
        ...
        actionArea = `<button class="uha-btn uha-btn-outline" style="width:auto; padding:5px 10px; font-size:11px;" onclick="openScoreModal(${divIdx}, ${rIdx}, ${mIdx}, '${bracketType}')">Edit Score</button>`;
    } else {
